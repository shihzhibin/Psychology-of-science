...
>In Figure 1, we present a series of four scatter plots to help visually represent the hours worked and well-being group effect and to demonstrate why between-group correlations from randomly formed groups are similar to the magnitudes of raw correlations. Scatter plots on the top, __1(a) and 1(c)__, show relationships __between work hours and well-being__. Plots on the bottom, __1(b) and 1(d)__, show relationships between __vertical cohesion and well-being__. Plots on the left, __1(a) and 1(b)__, are scatter plots from __the actual 99 U.S. Army companies__. Scatter plots on the right, __1(c) and 1(d)__, are from one set of __99 randomly formed groups__.

>In the scatter plots, the slopes based on individual level data ( N = 7,382) are presented with dotted lines. The slopes based on group level data ( N = 99) are presented with solid lines. These slopes are one way to visually represent group effects and equivocal effects. The upper left plot shows the group effect for the work hours and well-being relationship. It is apparent from the plot that the slope based on company-level data is steeper than the slope based on the individual level data. In contrast, the plot on the lower left (between vertical cohesion and well-being) represents an equivocal relationship: The slopes based on the company-level data and the slopes based on the individual level data appear quite similar.

>The scatter plots on the right side of Figure 1 demonstrate why between- group correlations for randomly formed groups tend to be of the same magni- tude as raw correlations. Scatter Plots l(c) and l(d) contrast slopes based on randomly formed group data with slopes based on individual-level data. It is apparent that the slopes are similar. This indicates that individual-level rela- tionships tend to be reflected at the group level even when the groups are formed by using a random number generator.

...
> Frequently cited job stress theories such as cybernetic theory (Cummings & Cooper, 1979; Edwards, 1992)
> Person-environment fit theory(French,Caplan,&Harrison,1982)
> Transactional model(Lazarus&Folkman,1984)
> Facet model (Beehr & Newman, 1978) 
> Share one key similarity: They are based on the assumption that individual differences in personal variables such as personality characteristics ,abilities, beliefs, and goals play crucial roles in determining how individuals perceive and respond to their environments. 
